...
%set inital values
droploc = evalin('base','initDrop'); 
personloc = evalin('base','initPsgr');
taxiloc = evalin('base','initTaxi');

set(handles.drop,'string',droploc);
set(handles.taxi,'string',taxiloc);
set(handles.passenger,'string',personloc);
...
policy=[];
number = 0;
policy_on=get(handles.policyPanel,'selectedobject');
switch policy_on
 case handles.pickPolicy
     policy =  evalin('base','policy1'); 
     number = 1;
 case handles.dropPolicy
     policy = evalin('base','policy2');
     number= 2;
    otherwise
     return;
end

set(handles.pos1,'string',getDirection(policy(1,1),number));
set(handles.pos2,'string',getDirection(policy(2,1),number));
set(handles.pos3,'string',getDirection(policy(3,1),number));
set(handles.pos4,'string',getDirection(policy(4,1),number));
set(handles.pos5,'string',getDirection(policy(5,1),number));
set(handles.pos6,'string',getDirection(policy(6,1),number));
set(handles.pos7,'string',getDirection(policy(7,1),number));
set(handles.pos8,'string',getDirection(policy(8,1),number));
set(handles.pos9,'string',getDirection(policy(9,1),number));
set(handles.pos10,'string',getDirection(policy(10,1),number));
set(handles.pos11,'string',getDirection(policy(11,1),number));
set(handles.pos12,'string',getDirection(policy(12,1),number));
set(handles.pos13,'string',getDirection(policy(13,1),number));
set(handles.pos14,'string',getDirection(policy(14,1),number));
set(handles.pos15,'string',getDirection(policy(15,1),number));
set(handles.pos16,'string',getDirection(policy(16,1),number));
set(handles.pos17,'string',getDirection(policy(17,1),number));
set(handles.pos18,'string',getDirection(policy(18,1),number));
set(handles.pos19,'string',getDirection(policy(19,1),number));
set(handles.pos20,'string',getDirection(policy(20,1),number));
set(handles.pos21,'string',getDirection(policy(21,1),number));
set(handles.pos22,'string',getDirection(policy(22,1),number));
set(handles.pos23,'string',getDirection(policy(23,1),number));
set(handles.pos24,'string',getDirection(policy(24,1),number));
set(handles.pos25,'string',getDirection(policy(25,1),number));


function val = getDirection(policyval,number)
    switch policyval
        case 1
        val = '^';
        case 2
